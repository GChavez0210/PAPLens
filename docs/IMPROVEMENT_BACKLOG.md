...
- Line numbers were verified against the repo as of commit `994a293`. If the file has
  drifted, search for the quoted code instead of trusting the line number.
